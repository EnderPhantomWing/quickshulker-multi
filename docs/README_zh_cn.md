...
使用多版本构建工具 `preprocessor` 快速构建多个 Minecraft 版本的 mod。
...
单击下面的链接进行下载。  
请为您的 Minecraft 版本选择合适的模组。

* [最新Release (GitHub Release)](https://github.com/EnderPhantomWing/quickshulker-multi/releases/latest)
